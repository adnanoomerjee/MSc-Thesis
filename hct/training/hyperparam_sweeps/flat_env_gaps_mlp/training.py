...
from hct.training.hyperparam_sweeps.flat_env_gaps_mlp.run import hyperparameter_sweep, env_name
...
def main(argv):
  ...
  savepath = f'hct/training/hyperparam_sweeps/flat_env_gaps_mlp/runs/'
  ...
  training_run(env_name=env_name, env_parameters=env_p, train_parameters=train_p, variant_name=f'{config}', filepath=savepath)
