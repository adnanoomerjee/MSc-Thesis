...
env_name = 'FlatGapsEnv'
filepath = Path('/nfs/nhome/live/aoomerjee/MSc-Thesis/hct/training/hyperparam_sweeps/flat_env_gaps_mlp/runs')

FLAT_ENV_DENSE_PARAMETERS = {
    'reward_type': ['dense'],
    'reward_movement': ['position', 'velocity'],
    'architecture_configs': [DEFAULT_MLP_CONFIGS, LARGE_MLP_CONFIGS, VLARGE_MLP_CONFIGS]
    }

FLAT_ENV_SPARSE_PARAMETERS = {
    'reward_type': ['sparse'],
