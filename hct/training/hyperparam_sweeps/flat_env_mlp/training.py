...
from hct.training.hyperparam_sweeps.flat_env_mlp.run import hyperparameter_sweep
...
def main(argv):
  ...
  savepath = f'hct/training/hyperparam_sweeps/flat_env_mlp/runs/'
  ...
  training_run(env_name='FlatEnv', env_parameters=env_p, train_parameters=train_p, variant_name=f'{config}', filepath=savepath)
