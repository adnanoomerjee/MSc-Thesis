...
low_level_modelpath = "/nfs/nhome/live/aoomerjee/MSc-Thesis/hct/training/hyperparam_sweeps_v2/hma/low_level/runs"
low_level_model_ids = [i for i in range(8)]
low_level_models = [f"{low_level_modelpath}/{i}" for i in low_level_model_ids]

mid_level_modelpath = "/nfs/nhome/live/aoomerjee/MSc-Thesis/hct/training/hyperparam_sweeps_v2/hma/mid_level/runs"
